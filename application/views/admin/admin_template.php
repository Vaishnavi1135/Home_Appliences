...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-dark " style=" height:70px; padding-bottom:8px">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="<?php echo base_url('admin/profile');?>">
        <img src="<?= base_url()?>\assets\images\user4-128x128.jpg"  style="height:40px; width:40px; margin-bottom:20px;" class=" rounded-pill">
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <div class="dropdown-divider"></div>
        <div class="profile_pic" style="height:180px"> 
            <img src="<?= base_url()?>\assets\images\user4-128x128.jpg"  style="height:50px; width:50px; margin-left:115px; margin-top:30px;" class=" rounded-pill">
            <h7 style="margin-left:105px;">Nina Mcintire</h7>
            <h7 style="margin-left:70px;">ninamcintire@gmail.com</h7>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">KPM</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class=" navbar navbar-expand-sm mt-2">
        <ul class="navbar-nav  nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link <?=$active=='Plans'?'active':''?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url("admin/plans/add");?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url("admin/services/add");?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url("admin/review/add");?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
...
<div class="content-wrapper">
 ...
 <?= $content ?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024-2025 <a href="https://adminlte.io">KPM.io</a>.</strong>
    All rights reserved.
