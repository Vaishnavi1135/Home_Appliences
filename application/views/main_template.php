...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url();?>/assets/css/fontawsom-all.min.css" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow border-top border-5 border-primary sticky-top p-0">
        <a href="<?php echo base_url('home');?>" class="navbar-brand bg-primary d-flex align-items-center px-4 px-lg-5">
            ...
            <div class="copyright">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        ...
                        Designed By <a class="border-bottom" href="https://htmlcodex.com">Pratik & Vaishnavi</a>
