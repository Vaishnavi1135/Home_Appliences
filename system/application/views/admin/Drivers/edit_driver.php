    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo form_hidden('id', $drivers->id); ?>
                ...
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        <input type="text" class="form-control" name="license_no" id="license_no" value="<?= $drivers->license_no ?>" >
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        <input type="text" class="form-control" name="adhar_no" id="adhar_no" value="<?= $drivers->adhar_no ?>" >
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        <select class="form-control" name="capacity" id="capacity" required>
                            ...
                            <option value="5" <?= $drivers->capacity == "5" ? "selected" : "" ?>>0-0.1 Tons</option>
