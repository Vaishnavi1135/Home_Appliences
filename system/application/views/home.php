...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="<?php echo base_url();?>\assets\images\bidkar-transport-shiroli-midc-kolhapur-packers-and-movers-all-india--0gqsxt00cs.jpg" alt="First slide">
        ...
        <div class="container py-5">
            <div class="row g-5" >
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-5">With a mission to revolutionize the relocation experience, ShiftingBazar set out on its journey. Our founders realized the need for a reliable platform to link people and businesses with reputable packers and movers after they had personally experienced the difficulties of moving. </p>
        ...
        <div class="container feature pb-5 px-lg-0">
            <div class="row g-5 mx-lg-0">
                <div class="col-lg-6 feature-text wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">We Are Trusted Kolhapur Company Since 1990</h1>
                    <div class="d-flex mb-5 wow fadeInUp" data-wow-delay="0.3s">
                        <i class="fa fa-globe text-primary fa-3x flex-shrink-0"></i>
                        <div class="ms-4">
                            <h5>Who We Are</h5>
                            <p class="mb-0">Expertly and attentively guiding through relocations
                                    Or
                                    Moving with Skill and Attention
                                    Revolutionizing Relocations: Efficiency. Trust. Satisfaction.
                                    Because we understand the value and importance of your belongings.</p>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="price-item">
                                ...
                                <div class="p-4 pt-0">
                                    ...
                                    <p><i class="fa fa-check text-success me-3"></i><?= $value->services ?></p>
                                    <a class="btn-slide mt-2" href="<?php echo base_url("home/free_quote");?>"><i class="fa fa-arrow-right"></i><span>Order Now</span></a>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
        ...
        <div class="container py-6">
            ...
            <h3 class="text-secondary text-uppercase mb-3">Contact Us</h3>
                ...
                <div class="col-lg-6">
                    ...
                    <?php echo form_open("contact/save",array('id'=>"submit",'method'=>'post'));?>
                    <?php echo form_hidden('id',0); ?>
                            <div class="row g-3">
                                <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control border-0" placeholder="Your Name" name="name" id="name" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="email" class="form-control border-0" placeholder="Your Email" name="email" id="email" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-12">
                                    <input type="phone" class="form-control border-0" placeholder="Your Mobile" name="phone" id="phone" style="height: 55px;">
                                </div>
                                
                                <div class="col-12">
                                    <textarea class="form-control border-0" name="special_note" id="special_note" placeholder="Special Note"></textarea>
                                </div>
                                <div class="col-12">
